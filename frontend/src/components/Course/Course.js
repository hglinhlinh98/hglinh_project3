          ...
          <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
              <div class="about-content col-lg-12">
                <h1 class="text-white">Khóa học của Trung tâm</h1>
              </div>
            </div>
          </div>
        </section>
            ...
            <div class="row d-flex justify-content-center">
              <div class="menu-content pb-70 col-lg-8">
                <div class="title text-center">
                  <h1 class="mb-10">Các khóa học đang mở</h1>
                  <p>
                    Các khóa học được đầu tư và chuẩn bị kỹ lưỡng giúp nâng cao
                    khả năng của bạn.
                  </p>
                </div>
              </div>
        ...
        <section class="cta-one-area relative section-gap">
          <div class="container">
            ...
            <div class="row justify-content-center">
              <div class="wrap">
                <h1 class="text-white">Trở thành học viên tại trung tâm!</h1>
                <p>
                  Hãy tham gia bài kiểm tra đánh giá trình độ đầu vào để có thể
                  nhận được tư vấn chính xác nhất nhé!
                </p>
                <a class="primary-btn wh" target="_blank" href="/test">
